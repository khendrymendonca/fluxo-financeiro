...
export type ShortcutId = 'dashboard' | 'transactions' | 'cards' | 'accounts' | 'goals' | 'bills' | 'categories' | 'reports' | 'debts' | 'simulator' | 'cost-analysis' | 'export' | 'emergency' | 'profile' | 'projection';
