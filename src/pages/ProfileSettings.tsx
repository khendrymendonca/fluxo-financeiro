...
export function ProfileSettings() {
    ...
    const availableShortcuts: { id: ShortcutId; label: string; icon: any }[] = [
        ...
        { id: 'bills', label: 'Contas Recorrentes', icon: Receipt },
        { id: 'accounts', label: 'Contas', icon: Wallet },
        { id: 'reports', label: 'Relatórios', icon: LineChart },
        { id: 'cost-analysis', label: 'Análise de Custos', icon: PieChart },
    ];
                                    ...
                                    <div className="space-y-5 animate-in fade-in duration-300">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <ul className="list-disc text-xs text-muted-foreground pl-8 space-y-1">
                                                ...
                                                <li><strong className="text-foreground">Contas em Dia</strong>: Pagar contas recorrentes e faturas até a data de vencimento preserva seu Score em 1000 pontos.</li>
                                            </ul>
                                        </div>
