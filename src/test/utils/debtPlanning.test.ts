...
function makePlan(overrides: Partial<MonthPlanEngineResult> = {}): MonthPlanEngineResult {
  return {
    ...
    totalAccountBalance: overrides.totalAccountBalance ?? 5000,
    openExpensesTotal: overrides.openExpensesTotal ?? 1200,
    cashBalance: overrides.cashBalance ?? 3800,
    overdueOpenExpensesTotal: overrides.overdueOpenExpensesTotal ?? 0,
    overdueOpenExpensesCount: overrides.overdueOpenExpensesCount ?? 0,
    upcomingOpenExpenses: overrides.upcomingOpenExpenses ?? [],
