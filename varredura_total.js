...
async function varreduraTotal() {
  const response = await fetch(`${supabaseUrl}/rest/v1/transactions?user_id=eq.${userId}&description=ilike.Salário&deleted_at=is.null`, {
