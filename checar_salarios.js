...
async function checarSalarios() {
  const response = await fetch(`${supabaseUrl}/rest/v1/transactions?user_id=eq.${userId}&description=ilike.Salário&date=gte.2026-04-01&date=lte.2026-04-30&deleted_at=is.null`, {
