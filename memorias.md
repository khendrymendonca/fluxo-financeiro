...
08/04/2026	ProfileSettings.tsx / FloatingNavMenu.tsx	Remoção do item "Início" do menu de escolha de atalhos mobile. Novo limite estrito de 4 atalhos simultâneos. Refatoração geométrica do FAB orbital (arco 150° a 30° com centro em 32px) para centralização absoluta e troca do ícone gatilho para Plus.
