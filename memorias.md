...
08/04/2026	ProfileSettings.tsx / FloatingNavMenu.tsx	Remoção do item "Início" do menu de escolha de atalhos mobile. Novo limite estrito de 4 atalhos simultâneos. Refatoração geométrica do FAB orbital (arco 180° a 0°) com ancoragem central absoluta via transform:translate(-50%,-50%) para garantir simetria perfeita independente da largura dos rótulos. Troca do ícone gatilho para Plus.
