...
08/04/2026	ProfileSettings.tsx / FloatingNavMenu.tsx	Remoção do item "Início" do menu de escolha de atalhos mobile. Novo limite estrito de 4 atalhos simultâneos. Refatoração geométrica do FAB orbital (arco 180° a 0°) com ancoragem via @keyframes scaleInOrbital (translate -50%, -24px), garantindo que o centro dos botões de 48px permaneça exatamente sobre o arco. Troca do ícone gatilho para Plus.
