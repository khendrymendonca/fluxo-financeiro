...
## 01/06/2026
- Remo��o da tela de Proje��o e Estrat�gia.
- Ajuste no visual do filtro de categorias da Gest�o de Contas.
- Remo��o da mensagem motivacional da Reserva de Emerg�ncia.
- Desativa��o do tema de P�scoa.

- Faturas de cart�o de cr�dito classificadas logicamente como 'Cart�o de Cr�dito' em vez de 'N�o identificadas'.
- Ajuste no visual do filtro de categorias da tela de Lan�amentos para usar o componente Select do design system.
