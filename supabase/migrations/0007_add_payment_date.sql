...
-- Exemplo: parcela vence em Dezembro/2030 mas foi antecipada e paga em MarÃ§o/2026

ALTER TABLE transactions 
ADD COLUMN IF NOT EXISTS payment_date DATE;

-- Atualizar transaÃ§Ãµes jÃ¡ pagas com a data de vencimento como data de pagamento
UPDATE transactions 
