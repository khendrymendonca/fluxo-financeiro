-- ==========================================================
-- SCRIPT DE MODERNIZAÇÃO DO BANCO DE DADOS (MVP)
-- Conteúdo: Soft Delete + Migração de Bills + Lazy Generation
-- ==========================================================

BEGIN;

-- 1. ADICIONAR COLUNA DE SOFT DELETE (Exclusão Lógica)
-- Garante que as transações possam ser "excluídas" sem perda de dados
DO $$ 
BEGIN 
